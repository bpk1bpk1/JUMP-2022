...
class Recommend_Carbon_Portfolio:
    def __init__(self):
        ...
        self.tangible_impact = pd.read_csv("Country.csv", index_col=False)
    ...
    def print_portfolio(self):
        ...
        print("The sustainability rating has increased by: ",
              ...
              "%")
        decreased_carbon_footprint = self.current_carbon_footprint - self.expected_carbon_footprint
        ...
        print("The potential portfolio has reduced ~",
              ...
              " tCO\u2082e/mUSD")
        print("******************************************************************")
        self.tangible_impact['GDP/mUSD'] = self.tangible_impact['GDP']/1000000
        self.tangible_impact['Normalized'] = self.tangible_impact['Emissions(T)']/self.tangible_impact['GDP/mUSD']
        qatar_percentage = self.tangible_impact.loc[self.tangible_impact['Country'] == 'Qatar']['Normalized'].iloc[0]
        print("Qatar was ranked the first in the world for the carbon emissions generated", "{:.2f}".format(qatar_percentage), "(tCO\u2082e/mUSD) because of fossil fuels in 2019")
        percentage = ((decreased_carbon_footprint/qatar_percentage)*100)
        print("The decrease in the carbon emissions is equal to: ", "{:.2f}".format(percentage), "% generated by Qatar in 2019")
        print("##################################################################")
